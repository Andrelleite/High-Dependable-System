        ...
        try {
            if(op == 1){
                ...
                for (ServerInterface s: this.networkTosymKey.keySet()) {
                    ...
                    ServerReturn r = s.obtainUsersAtLocation(locationEnc,epochEnc,this.requestId.get());
                ...
                for (ServerInterface s: this.networkTosymKey.keySet()) {
                    ...
                    ServerReturn r = s.obtainLocationReport(userEnc,epochEnc,this.requestId.get());
                    reports = r.getReports();
